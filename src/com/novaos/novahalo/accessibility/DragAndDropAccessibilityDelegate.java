...
public abstract class DragAndDropAccessibilityDelegate extends ExploreByTouchHelper
    ...
    protected boolean onPerformActionForVirtualView(int viewId, int action, Bundle args) {
        if (action == AccessibilityNodeInfoCompat.ACTION_CLICK && viewId != ExploreByTouchHelper.INVALID_ID) {
    ...
    @Override
    protected void onPopulateEventForVirtualView(int id, @NonNull AccessibilityEvent event) {
