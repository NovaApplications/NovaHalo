...
import com.novaos.novahalo.UninstallDropTarget.DropTargetSource;
import com.novaos.novahalo.accessibility.AccessibileDragListenerAdapter;
import com.novaos.novahalo.accessibility.OverviewAccessibilityDelegate;
import com.novaos.novahalo.accessibility.OverviewScreenAccessibilityDelegate;
import com.novaos.novahalo.accessibility.WorkspaceAccessibilityHelper;
...
import com.novaos.novahalo.dragndrop.DragScroller;
import com.novaos.novahalo.dragndrop.DragView;
import com.novaos.novahalo.dragndrop.SpringLoadedDragController;
...
import com.novaos.novahalo.graphics.DragPreviewProvider;
import com.novaos.novahalo.util.ItemInfoMatcher;
import com.novaos.novahalo.util.LongArrayMap;
import com.novaos.novahalo.util.MultiStateAlphaController;
import com.novaos.novahalo.util.Thunk;
import com.novaos.novahalo.util.VerticalFlingDetector;
import com.novaos.novahalo.util.WallpaperOffsetInterpolator;
import com.novaos.novahalo.widget.PendingAddShortcutInfo;
...
public class Workspace extends PagedView
    ...
    public void initPullDownAction() {
        for (int i = 0; i < getChildCount(); i++) {
            View page = getChildAt(i);
            if (!(page instanceof CellLayout)) continue;
            CellLayout layout = (CellLayout) page;
            
            String action = FeatureFlags.swipeDownAction(getContext().getApplicationContext());
                ...
                layout.setOnTouchListener(new VerticalFlingDetector(mLauncher) {
                    ...
                    public boolean onTouch(View v, MotionEvent ev) {
                        ...
                        if (super.onTouch(v, ev)) {
                            mLauncher.performSwipeDownAction();
                            return true;
                        }
                        return false;
                    }
    ...
    protected void overScroll(float amount) {
        ...
        if (shouldScrollOverlay && mLauncherOverlay != null) {
    ...
    void setHotseatAlphaAtIndex(float alpha, int index) {
