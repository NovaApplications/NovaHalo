...
import com.novaos.novahalo.compat.AlphabeticIndexCompat;
import com.novaos.novahalo.model.AppNameComparator;
...
public class AlphabeticalAppsList {
    ...
    private boolean mShowWorkApps = false;
    private boolean mFilterByUser = false;
    ...
    /**
     * Sets the user filter for the apps list.
     */
    public void setWorkProfileFilter(boolean showWorkApps) {
        mFilterByUser = true;
        mShowWorkApps = showWorkApps;
        updateAdapterItems();
    }
...
//    }
    ...
    private List<AppInfo> getFiltersAppInfos() {
        ...
        if (mFilterByUser) {
            ...
            UserHandle myUser = com.novaos.novahalo.Utilities.myUserHandle();
            for (AppInfo info : apps) {
                boolean isWorkApp = !myUser.equals(info.user);
                if (isWorkApp == mShowWorkApps) {
                    result.add(info);
                }
            }
            return result;
