...
import com.novaos.novaos.BubbleTextView.BubbleTextShadowHandler;
import com.novaos.novaos.LauncherSettings.Favorites;
import com.novaos.novaos.accessibility.DragAndDropAccessibilityDelegate;
import com.novaos.novaos.accessibility.FolderAccessibilityHelper;
...
import com.novaos.novaos.util.CellAndSpan;
import com.novaos.novaos.util.GridOccupancy;
import com.novaos.novaos.util.ParcelableSparseArray;
...
public class CellLayout extends ViewGroup implements BubbleTextShadowHandler {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mFixedWidth > 0 && mFixedHeight > 0) {
            ...
            Log.w(TAG, "CellLayout measured with UNSPECIFIED dimensions");
        }
